...
console.log(10 > 6); // greater than :ture
console.log(10 >= 6); // greater than or equal: ture
...
const rak2 = {name : 'rak'};
const rak3 = rak1;
console.log(rak1==rak2);
console.log(rak1===rak2);
console.log(rak1===rak3);
...
// for loop, for(vegin; condition; step)
for (i =3; i>0; i--){
    console.log(`for ${i}`);
}
