...
const sceneInfo = [
    {//section-0
        heightCnt : 5, //window.innerHeight 의 몇배로 height 설정
        scrollHeight : 0,
        imgCount : 117,
        objs : {
        ...
        values : {
            ...
            msgB_opcity_in :    [0,1,  {start:0.4,end:0.5}],
            msgB_position_in :  [30,0, {start:0.4,end:0.5}],
            msgB_opcity_out :   [1,0,  {start:0.5,end:0.6}],
            msgB_position_out : [0,-30,{start:0.5,end:0.6}],
            msgC_opcity_in :    [0,1,  {start:0.6,end:0.7}],
            msgC_position_in :  [30,0, {start:0.6,end:0.7}],
            msgC_opcity_out :   [1,0,  {start:0.7,end:0.8}],
            msgC_position_out : [0,-30,{start:0.7,end:0.8}],
            msgD_opcity_in :    [0,1,  {start:0.8,end:0.9}],
            msgD_position_in :  [30,0, {start:0.8,end:0.9}],
            msgD_opcity_out :   [1,0,  {start:0.9,end:  1}],
    ...
    {//section-2
        ...
        values : {
            ...
            msgB_opcity_in :    [0,1,  {start:0.4,end:0.5}],
            msgB_position_in :  [30,0, {start:0.4,end:0.5}],
            msgB_opcity_out :   [1,0,  {start:0.6,end:0.7}],
            msgB_position_out : [0,-30,{start:0.6,end:0.7}],
            msgC_opcity_in :    [0,1,  {start:0.8,end:0.9}],
            msgC_position_in :  [30,0, {start:0.8,end:0.9}],
            msgC_opcity_out :   [1,0,  {start:0.9,end:  1}],
            msgC_position_out : [0,-30,{start:0.9,end:  1}],
        },
    },
    {//section-3
        heightCnt : 5,
